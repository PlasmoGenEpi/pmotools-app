    ...
    def transform_and_save_data(
        ...
        if mapped_fields and selected_optional_fields != "Error":
            ...
            if st.button("Transform Data"):
                ...
                try:
                    st.success("Experiment Information has been saved!")
...
if __name__ == "__main__":
    ...
    required_alternate_fields = schema_fields["experiment_level_metadata"][
        "required_alternatives"
    ]
    optional_fields = schema_fields["experiment_level_metadata"]["optional"]
    optional_alternate_fields = schema_fields["experiment_level_metadata"][
        "optional_alternatives"
    ]
    app = ExperimentMetadataPage(
        required_fields,
        required_alternate_fields,
        optional_fields,
        optional_alternate_fields,
